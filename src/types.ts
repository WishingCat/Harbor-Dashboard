...
export type TaskSet = {id: string; project_id: string; name: string; author: string; created_at: string; tasks_count: number; rollouts_count: number; pending_count: number; approved_count: number; can_delete?: boolean};
export type TaskStatus = 'pending' | 'approved' | 'changes_requested';
export type Task = {id: string; project_id: string; task_set_id: string; task_set_name: string; slug: string; title: string; summary: string; description: string; category: string; difficulty: 'easy' | 'medium' | 'hard'; tags: string[]; status: TaskStatus; author: string; created_at: string; updated_at: string; files_count: number; rollouts_count: number; reviews_count: number; is_demo: boolean};
